...
| 2026-08-27 | FS-007..FS-008 | Auth & Security | Centralize authentication method capabilities, prevent insecure client OTP, and document security model | `auth_service.dart`, `docs/SECURITY.md` | Code analysis & unit tests | - |
