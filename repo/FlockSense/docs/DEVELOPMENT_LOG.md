...
| 2026-08-27 | FS-014..FS-024 | Farms | Add farm dimension validation, capacity estimation, and comprehensive model test coverage | `farm_model.dart`, `farm_model_test.dart` | `flutter test test/features/farms/domain/farm_model_test.dart` (5/5 passed) | - |
