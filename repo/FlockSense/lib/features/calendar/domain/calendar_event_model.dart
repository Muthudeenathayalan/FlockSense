...
class CalendarEventModel {
  ...
  final String title;
  final String
  eventType; // 'Vaccination', 'Medicine', 'Feed Delivery', 'Water Check', 'Cleaning Schedule', 'Bird Weighing', 'Batch Placement', 'Harvest Date', 'Inventory Restock', 'Custom Reminder'
