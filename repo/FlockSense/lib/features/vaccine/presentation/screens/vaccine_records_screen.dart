...
class _VaccineRecordsScreenState extends State<VaccineRecordsScreen> {
  ...
  Widget build(BuildContext context) {
        ...
        appBar: AppBar(
          title: Text(
            widget.batchName == null
                ? 'Vaccination'
                : 'Vaccination • ${widget.batchName}',
          ),
        ),
        body: const Center(
          child: Text('Open vaccination from a batch to log doses.'),
        ),
      );
    }
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<VaccineRecordModel>>(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Log the first vaccine dose for this batch',
