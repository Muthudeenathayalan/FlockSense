    ...
    try {
      ...
      alerts.add(
        NotificationModel(
          ...
          body:
              'Cobb 500 Batch #4 reaches Day 14 today. Administer Newcastle Disease booster vaccine.',
      ...
      alerts.add(
        NotificationModel(
          ...
          body:
              'Green Valley Batch #4 will reach 2.2kg target harvest weight in 5 days. Prepare buyer logistics.',
      ...
      alerts.add(
        NotificationModel(
          ...
          body:
              'Mortality increased by 4.2% over 48 hours. Temperature humidity index (THI) is 82. Increase tunnel fan speed.',
      ...
      alerts.add(
        NotificationModel(
          ...
          body:
              'Feed usage is 12% above benchmark curve. Check feeder tray heights to prevent feed spillage.',
          type: NotificationType.ai,
          priority: NotificationPriority.normal,
