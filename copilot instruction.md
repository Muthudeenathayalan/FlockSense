...
- There is no build system, source code, or tests checked in currently 1 treat this as a notes/idea repository unless the user supplies additional files.
...
- Do not assume package managers, CI, or linters 1 confirm before adding `package.json`, `pyproject.toml`, `.github/workflows`, or similar files.
...
- Keep changes minimal and tightly scoped 1 this repo appears to be idea/setup notes rather than production code.
